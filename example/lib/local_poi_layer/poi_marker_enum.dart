...
import 'package:trufi_core_example/local_poi_layer/markers_from_assets.dart';
...
extension LayerIdsToString on POILayerIds {
  ...
  static String? _translates(POILayerIds enumData) {
    return {
      POILayerIds.attractionsAndMonuments: "layerAttractionsAndMonuments",
      POILayerIds.parksAndSquares: "layerParksAndSquares",
      POILayerIds.cinemas: "layerCinemas",
      POILayerIds.pharmacies: "layerPharmacies",
      POILayerIds.hospitals: "layerHospitals",
      POILayerIds.schools: "layerSchools",
      POILayerIds.institutes: "layerInstitutes",
      POILayerIds.shoppingCentersAndSupermarkets:
          "layerShoppingCentersAndSupermarkets",
      POILayerIds.interprovincialStops: "layerInterprovincialStops",
      POILayerIds.stadiumsAndSportsComplexes: "layerStadiumsAndSportsComplexes",
      POILayerIds.libraries: "layerLibraries",
      POILayerIds.terminalsAndStations: "layerTerminalsAndStations",
      POILayerIds.museumsAndArtGalleries: "layerMuseumsAndArtGalleries",
      POILayerIds.universities: "layerUniversities",
    }[enumData];
  }
  ...
  String getTranslate() => _translates(this) ?? 'LayerIds type not found';
