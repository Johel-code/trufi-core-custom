...
import 'package:trufi_core_example/local_poi_layer/poi_layer.dart';
import 'package:trufi_core_example/local_poi_layer/poi_marker_enum.dart';

final List<MapLayerContainer> customLayersTrufi = [
  MapLayerContainer(
    name: (context) => "layerGroupHealthServices",
  ...
  MapLayerContainer(
    name: (context) => "layerGroupLeisure",
    icon: (context) => const Icon(
      Icons.stars,
    ),
    layers: [
  ...
  MapLayerContainer(
    name: (context) => "layerGroupEducation",
    icon: (context) => const Icon(
